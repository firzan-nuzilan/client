...
class CompanytecClient {
    ...
    connect() {
        return new Promise((resolve, reject) => {
            ...
            console.log("hello", this.port, this.host)
     ...
     */
    async recordIdentifier(control, parameter, identifier, shiftA_start, shiftA_end, shiftB_start, shiftB_end) {
    ...
    async clearIdentifierMemory() {
        const command = this.buildCommand('?F', '00L0000000000000000000000100000000');
        return await this.sendCommand(command);
    }
     ...
     */
    async setPresetIdentified(nozzle, identifier, identifierType, authorization, presetValue, timeout, presetType) {
